...
export const SelecNavtedPing = (item) => {
  ...
  export const handelPreview = (puntero , indice,setPuntero , setIndice , dispatch) => {
    ...
    export  const handelSetPuntero = (i , indice,setPuntero , setIndice , dispatch , elementos) => {
    ...
    export  const handelNext = (puntero , indice,setPuntero , setIndice , dispatch ,elementos) => {
